...
<body>
	...
	<div class="card">
		...
		<div class="card-body">
			<form method="POST" action="simpan_ayah.php" >
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pendidikanAy" class="form-control" required="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pekerjaanAy" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="penghasilanAy" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="kebutuanAy" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
