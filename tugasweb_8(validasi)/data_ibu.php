		...
		<div class="card-body">
			<form method="POST" action="simpan_ibu.php" >
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pendidikanIb" class="form-control" required="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pekerjaanIb" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="penghasilanIb" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="kebutuhanIb" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
